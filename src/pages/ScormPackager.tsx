...
\
  ...
  js / lumiere - scorm - engine.js

  js / course.js
  courseData && courseData.pages && courseData.pages.map((page: any, index: number) => (
                    
                      
                        
                        pages/page{index + 1}.html
                      
                    
                  )
  )
  quizData && pages / quiz.html
